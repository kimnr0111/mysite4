				...
				<div id="list">
					...
					<ul id="viewArea">
						...
						<c:forEach items="${gList }" var="vo" varStatus="status">
							<li>
								<div class="view" id="view-${vo.no }" data-imgno="${vo.no}">
		...
		<div class="modal-dialog" >
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="formgroup" id="viewModelArea">
						 <!-- ajax로 처리 : 이미지출력 위치-->
					</div>
...
$(".view").on("click", function(){
	...
	$.ajax({
		...
		url : "${pageContext.request.contextPath }/fileupload/getGallery",		
		type : "post",
		...
		success : function(galleryVo){
			...
			str += "<h3>코멘트</h3>";
			str += "<p>" + galleryVo.comments + "</p>";
			str += "<input type='text' id='imgNo' value='" + galleryVo.no + "'>";
			
			$("#viewModelArea").html(str);
...
$("#btnDel").on("click", function(){
	...
	$.ajax({
		...
		url : "${pageContext.request.contextPath }/fileupload/deleteGallery",		
		type : "post",
		//contentType : "application/json",
		data : {no: no},
		dataType : "json",
